...
- [references/annotated-bibliography.md](file:///c:/Users/tulal/thesis-mouse-biometrics/references/annotated-bibliography.md) — ~46 sources compiled by the thesis group (4 members),
...
- [references/measurement-comparison-survey.md](file:///c:/Users/tulal/thesis-mouse-biometrics/references/measurement-comparison-survey.md) — consolidated survey of mouse dynamics measurements,
...
- [references/literature-sources.md](file:///c:/Users/tulal/thesis-mouse-biometrics/references/literature-sources.md) — options, access methods, status, and instructions for querying academic APIs (arXiv, OpenAlex, Semantic Scholar, CORE, Crossref, etc.).
- [references/example-rrl-fetch.py](file:///c:/Users/tulal/thesis-mouse-biometrics/references/example-rrl-fetch.py) — automated fetch and cross-checking script for retrieving candidate literature from free/no-key APIs and comparing against the annotated bibliography.
- [references/pipeline.md](file:///c:/Users/tulal/thesis-mouse-biometrics/references/pipeline.md) — end-to-end methodology pipeline specification: short-signal segmentation, closed-form geometric mannerism extraction (Menger curvature, chord deviation, straightness ratio, convex hull), Discrete Fréchet distance comparison, and continuous dynamic trust scoring.
- [references/adviser-log.md](file:///c:/Users/tulal/thesis-mouse-biometrics/references/adviser-log.md) — running log of adviser meetings/feedback. Always check it before
...
1. Read [references/adviser-log.md](file:///c:/Users/tulal/thesis-mouse-biometrics/references/adviser-log.md) first. If it has entries, treat the most recent decisions
...
2. If relevant, read [references/annotated-bibliography.md](file:///c:/Users/tulal/thesis-mouse-biometrics/references/annotated-bibliography.md) for the specific theme in play
...
1. Reference [references/literature-sources.md](file:///c:/Users/tulal/thesis-mouse-biometrics/references/literature-sources.md) and run or inspect the output of `references/example-rrl-fetch.py`.
2. Cross-check each candidate's title/DOI against [references/annotated-bibliography.md](file:///c:/Users/tulal/thesis-mouse-biometrics/references/annotated-bibliography.md) (only genuinely new ones matter).
...
- Summarize it into the log's entry format (Context / Feedback / Decisions / Open questions),
  add it to the **top** of [references/adviser-log.md](file:///c:/Users/tulal/thesis-mouse-biometrics/references/adviser-log.md), and confirm back to the user in a
  couple of sentences what got logged.
- Don't editorialize or add feedback the adviser didn't give — this log is meant to be an
  accurate record, not an unverified opinion.
...
adviser meeting notes, or later a Methodology/Results draft they want context on, add them into `references/` (new files if the content is a different kind of
